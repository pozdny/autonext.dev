        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-currency-out"><span data-toggle="tooltip" title="<?php echo $help_currency_out; ?>"><?php echo $entry_currency_out; ?></span></label>
                <div class="col-sm-10">
                    <select name="config_currency_out" id="input-currency-out" class="form-control">
                        <?php foreach ($currencies as $currency) { ?>
                        <?php if ($currency['code'] == $config_currency_out) { ?>
                        <option value="<?php echo $currency['code']; ?>" selected="selected"><?php echo $currency['title']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $currency['code']; ?>"><?php echo $currency['title']; ?></option>
                        <?php } ?>
