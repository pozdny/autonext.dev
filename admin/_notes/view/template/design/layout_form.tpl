    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <td class="text-left" ><p style="font-weight: 700;margin-left: 10px;">Текст на странице</p></td>
            <script src="view/javascript/js/ckeditor/ckeditor.js"></script>
          <textarea id="aksd" name="home_article" style="resize:none;height:140px;border:1px solid #848484;padding:10px;" class="col-xs-12"><?php echo $home_article; ?></textarea>
            <script>CKEDITOR.replace('aksd');</script>
        </form>
      </div>
    </div>
  </div>
