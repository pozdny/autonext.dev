...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['home-article'])) {
            $data['home_article'] = $this->request->post['home_article'];
        } elseif (!empty($layout_info)) {
            $data['home_article'] = $layout_info['home_article'];
        } else {
            $data['home_article'] = '';
        }
        ...
        $data['language'] = $this->model_localisation_language->getLanguages();
