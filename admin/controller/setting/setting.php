...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['entry_currency_out'] = $this->language->get('entry_currency_out');
        ...
        $data['help_currency_out'] = $this->language->get('help_currency_out');
		...
		if (isset($this->request->post['config_telephone'])) {
			$data['config_telephone'] = $_POST['config_telefon'];
		} else {
        ...
        if (isset($this->request->post['config_currency_out'])) {
            $data['config_currency_out'] = $this->request->post['config_currency_out'];
        } else {
            $data['config_currency_out'] = $this->config->get('config_currency_out');
        }
