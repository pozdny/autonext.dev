...
<div class="form-group">
    <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_price_opt_big; ?></label>
    <div class="col-sm-10">
        <input type="text" name="price_opt_big" value="<?php echo $price_opt_big; ?>" placeholder="<?php echo $entry_price_opt_big; ?>" id="input-price-opt-big" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_price_opt; ?></label>
    <div class="col-sm-10">
        <input type="text" name="price_opt" value="<?php echo $price_opt; ?>" placeholder="<?php echo $entry_price_opt; ?>" id="input-price-opt" class="form-control" />
    </div>
</div>
<div class="form-group">
...
<div class="tab-pane" id="tab-reward">
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <input type="text" name="points" value="<?php echo $points; ?>" disabled placeholder="<?php echo $entry_points; ?>" id="input-points" class="form-control" />
        </div>
    </div>
    <div class="table-responsive">
